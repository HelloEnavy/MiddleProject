...
var positions = [
    {
        content: '<div style="background-color:azure; width=10px; text-align: center;">비트캠프</div>',
        ...
        linkC : '<div class="overlaybox"><div class="boxtitle">비트캠프<div class="close" onclick="closeOverlay()" title="닫기"></div></div><div class="first">' +
            '<div class="text"><a href="https://map.kakao.com/link/to/비트캠프,37.49940921486961, 127.02904695751812" style="color:blue" target="_blank">길찾기</a></div></div></div>'
    },
    {
        ...
        linkC : '<div class="overlaybox"> <div class="boxtitle"">미진식당<div class="close" onclick="closeOverlay()" title="닫기"></div></div><div class="first">' +
            '<div class="text"><a href="https://map.kakao.com/link/to/미진식당,37.49780488002854, 127.0285311430128" style="color:blue" target="_blank"></div>길찾기</a></div></div>'
    },
    {
        ...
        linkC : '<div class="overlaybox"><div class="boxtitle">곱스떡스<div class="close" onclick="closeOverlay()" title="닫기"></div></div><div class="first">' +
            '<div class="text"><a href="https://map.kakao.com/link/to/곱스떡스,37.5022283913203, 127.02729429671771" style="color:blue" target="_blank"></div>길찾기</a></div></div>'
    },
    {
        ...
        linkC : '<div class="overlaybox"><div class="boxtitle">정육도<div class="close" onclick="closeOverlay()" title="닫기"></div></div><div class="first">' +
            '<div class="text"><a href="https://map.kakao.com/link/to/정육도,37.50051601165904, 127.0282434729202" style="color:blue" target="_blank"></div>길찾기</a></div></div>'
    },
    {
        ...
        linkC : '<div class="overlaybox" ><div class="boxtitle">세컨드컵커피<div class="close" onclick="closeOverlay()" title="닫기"></div></div><div class="first">' +
            '<div class="text"><a href="https://map.kakao.com/link/to/세컨드컵커피,37.4999117373091, 127.02877027873477" style="color:blue" target="_blank"></div>길찾기</a></div></div>'
    }
];
